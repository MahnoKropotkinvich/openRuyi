...
Requires:       crate(path-dedot-3/default) >= 3.1.1
...
Requires:       crate(path-dedot-3/lazy-static-cache) >= 3.1.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(path-dedot-3/once-cell-cache) >= 3.1.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(path-dedot-3/unsafe-cache) >= 3.1.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(path-dedot-3/use-unix-paths-on-wasm) >= 3.1.1
