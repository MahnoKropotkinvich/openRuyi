...
Requires:       crate(indexmap-2/arbitrary) >= 2.14.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(borsh-1) >= 1.5.6
Requires:       crate(borsh-1/indexmap) >= 1.5.6
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(indexmap-2/quickcheck) >= 2.14.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(indexmap-2/rayon) >= 2.14.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(indexmap-2/sval) >= 2.14.0
