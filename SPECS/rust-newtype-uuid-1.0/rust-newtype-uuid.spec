...
Requires:       crate(uuid-1/default) >= 1.18.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(proptest-1/std) >= 1.7.0
...
Provides:       crate(%{pkgname}/schemars08) = %{version}
...
Requires:       crate(uuid-1/serde) >= 1.18.1
...
Requires:       crate(uuid-1/std) >= 1.18.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(uuid-1/v4) >= 1.18.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(uuid-1/v7) >= 1.18.1
