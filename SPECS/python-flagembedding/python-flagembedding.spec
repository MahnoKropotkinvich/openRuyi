...
BuildOption(check):  -e 'FlagEmbedding.evaluation.*' -e 'FlagEmbedding.abc.evaluation.*' -e 'FlagEmbedding.inference.reranker.decoder_only.models.gemma_model'
...
Provides:       python3-FlagEmbedding = %{version}-%{release}
%python_provide python3-FlagEmbedding
