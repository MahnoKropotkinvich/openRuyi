...
Requires:       crate(pyo3-macros-backend-0.27/default) >= 0.27.2
...
Requires:       crate(pyo3-macros-backend-0.27/experimental-async) >= 0.27.2
...
Requires:       crate(%{pkgname})
Requires:       crate(pyo3-macros-backend-0.27/experimental-inspect) >= 0.27.2
