...
Requires:       crate(unicode-names2-generator-1) >= 1.3.0
...
Requires:       crate(unicode-names2-generator-1) >= 1.3.0
Requires:       crate(unicode-names2-generator-1/timing) >= 1.3.0
Provides:       crate(%{pkgname}/generator-timing) = %{version}
